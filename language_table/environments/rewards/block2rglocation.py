...
BLOCK2GREEN_TARGET_DISTANCE = 0.05
...
class BlockToRGLocationReward(base_reward.LanguageTableReward):
    ...
    def __init__(self, goal_reward, rng, delay_reward_steps, block_mode):
        super(BlockToRGLocationReward, self).__init__(
    ...
    def get_goal_region(self):
        ...
        return self._target_translation, BLOCK2GOAL_TARGET_DISTANCE
