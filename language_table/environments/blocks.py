...
def get_all_block_subsets(mode, training):
    ...
    elif mode == LanguageTableBlockVariants.BLOCK_RGB:
...
FIXED_4_COMBINATION = ("red_moon", "blue_cube", "green_star", "yellow_pentagon")


# 8 total blocks + 1 goal purple pole, 2 of each color, 2 of each shape.
FIXED_8_COMBINATION_WPOLE = (
    "red_moon",
    "red_pentagon",
    "blue_moon",
    "blue_cube",
...
# RGB colors.
FIXED_RGB_COMBINATION = ("red_cube", "green_cube", "blue_cube")
