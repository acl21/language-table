...
from language_table.environments.rewards.block2colours import RED_GOAL, GREEN_GOAL, BLUE_GOAL, YELLOW_GOAL, GOAL_LOCATIONS
    ...
    def __init__(
        ...
        if reward_factory is not None:
            ...
            if goal_color is not None:
                ...
                elif "blue" in goal_color:
                    self._reward_calculator._goal = BLUE_GOAL
                elif "yellow" in goal_color:
                    self._reward_calculator._goal = YELLOW_GOAL
                else:
