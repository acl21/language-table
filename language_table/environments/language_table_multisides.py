...
class LanguageTable(gym.Env):
    ...
    def __init__(
        ...
        if reward_factory is not None:
            ...
            if goal_side is not None:
                self._reward_calculator.set_goal_from_text(goal_side)
            else:
                raise ValueError("Goal side must be specified.")
    ...
    def _reset_poses_randomly(self, blocks_on_table):
        ...
        # A small rectangle in the center top of the workspace.
        xmin, ymin = (0.16, -0.1)
        xmax, ymax = (0.30, 0.1)
        ...
        def _generate_pose():
            # A small rectangle in the center of the workspace.
            xmin, ymin = (0.35, -0.1)
            xmax, ymax = (0.50, 0.1)
